...
if __name__ == "__main__":
    if len(sys.argv) < 7:
        print(
            "ERROR: Arguments are PPI path, date (YYYYMMDD), baseline netCDF path, csv file path, choose use of UZ or Z, choose 00-11 or 12-23"
        )
        sys.exit(0)
    ...
    csv_filepath = csvdir + "rca_twicedaily_values.csv"
    ...
    if timeperiod == "00-12":
        ...
        print("ERROR: Must specify the time period for this day - 00-12 or 12-00")
