...
from rca_func_error import rca_func_error
...
if __name__ == "__main__":
    ...
    csv_filepath = csvdir + "rca_daily_values_error.csv"
    ...
    for f in glob.glob(os.path.join(datadir, "corcsaprM1*.cor-ppi*" + date + "*.h5")):
        print(f)
        try:
            DateTime, HDBZ95, VDBZ95 = rca_func_error(
